...
{   
    ...
    {                 
        ...
        let a1 = document.createElement('a');                        // creating anchor tag to display movie title and artist name
        a1.setAttribute('id', 'a_id');                                 // a_id is the id
        a1.className = "watchListItem";
        a1.innerHTML = event.target.parentElement.parentElement.children[1].innerHTML + "  " + '[' + event.target.parentElement.parentElement.children[2].innerHTML + ']' + ""; // inserting the title and artist name
        a1.href = movie_list.results[0].trackViewUrl;
